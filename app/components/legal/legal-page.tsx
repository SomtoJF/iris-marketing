      ...
      <main id="top">
        ...
        <div className="mx-auto grid max-w-[1440px] md:grid-cols-[minmax(220px,0.65fr)_minmax(0,1.35fr)]">
          <aside className="border-b border-ink px-5 py-10 md:border-b-0 md:border-r md:px-8 md:py-16">
            <div className="md:sticky md:top-24">
              ...
              <nav
                ...
                className="mt-5 grid grid-cols-2 gap-x-4 border-t border-ink/20 sm:grid-cols-3 md:grid-cols-1"
              >
          ...
          <div className="min-w-0 px-5 pb-24 pt-3 md:px-12 md:pb-32 md:pt-8 lg:px-20">
            ...
            <a
              href="#top"
              className="mt-16 inline-block border-b border-ink pb-1 text-xs font-black uppercase tracking-[0.1em] hover:text-purple-700"
            >
              Back to top ↑
            </a>
          </div>
...
export function LegalSection({
  ...
  return (
    <section
      id={sectionId(title)}
      className="border-b border-ink/25 py-9 last:border-b-0 md:py-12"
    >
      <div className="mb-5 flex items-start gap-4 md:gap-7">
        {/^\d+\./.test(title) && (
          <span className="pt-1 font-mono text-xs font-bold text-purple-700">
            {title.match(/^\d+/)?.[0].padStart(2, "0")}
          </span>
        )}
      ...
      <div className="space-y-5 [&_a]:underline [&_a]:decoration-purple-700/50 [&_a]:underline-offset-4 [&_a:hover]:decoration-purple-700">
        {children}
      </div>
    </section>
  );
